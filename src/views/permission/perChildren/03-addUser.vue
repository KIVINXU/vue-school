  ...
  <div class="col-sm-8">
    <div class="box">
      ...
      <div class="box-body">
        ...
        <form class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-xs-8">
              <select v-model="add_users.selected" name="" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-8">
              ...
              <span class="text-red small"
                ...
                两次密码输入不一致</span>
              <span class="text-red small" v-show="add_users.passwd2 === ''">请再次输入密码</span>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-xs-8">
              <input v-model.number="add_users.idle"
                     type="number" class="form-control"
                     placeholder="--输入范围300-7200s,不能为空--" step="100">
              <span class="text-red small"
          ...
          <div class="form-group">
            ...
            <div class="col-xs-8">
              <input v-model.number="add_users.alive"
                     type="number"
                     class="form-control"
                     placeholder="--输入范围600-86400s,不能为空--" step="100">
      ...
      <div class="box-footer text-center">
        <a href="javascript:void(0)" class="btn btn-primary" style="margin-right: 30px" @click="addUsers" >保存</a>
